...
class AccountBusinessDetailsCard extends StatelessWidget {
  const AccountBusinessDetailsCard({super.key, required this.model});
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              return accountDetailsCard(
                cost: model.businessStatistics[index].planCost,
                totalCost: model.businessStatistics[index].totalCost,
                name:model.businessStatistics[index] .planName,
                days: model.businessStatistics[index].planDays,
                paidCount: model.businessStatistics[index].paidLicencesCount,
                unPaidCount: model.businessStatistics[index].unpaidLicencesCount,
                totalCount: model.businessStatistics[index].totalLicencesCount,
              );
            },
            itemCount: model.businessStatistics.length,
          ),
          SizedBox(
            height: 20.h,
          ),
